    ...
    pricing: [
      {
        ...
        price: '1 500 €',
        frequency: 'projet',
        description: 'Pour les entrepreneurs et petites structures qui démarrent.',
        features: [
          'Logo principal (3 propositions)',
          'Palette couleurs + typographie',
          'Charte graphique simplifiée',
          'Formats livrés : print + web',
          '2 révisions incluses',
        ],
        excluded: ['Brand book complet', 'Motion identity', 'Accompagnement lancement'],
      ...
      },
      {
        ...
        price: '3 500 €',
        frequency: 'projet',
        description: 'L\'identité complète pour les marques qui veulent s\'imposer.',
        features: [
      ...
      },
      {
        ...
        price: 'Sur mesure',
        frequency: 'projet',
        description: 'Pour les marques ambitieuses qui veulent tout.',
        features: [
          'Tout du plan Studio',
          'Motion identity (logo animé)',
          'Naming & baseline',
          'Stratégie de marque complète',
          'Refonte totale si nécessaire',
