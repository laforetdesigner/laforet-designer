    ...
    pricing: [
      {
        ...
        features: [
          'Cadrage & Brief Créatif',
          'Moodboard',
          { text: 'Direction artistique', sub: [
            'Logo principal et secondaire',
            'Palette couleurs + typographie',
            'Assets visuels (icônes, images, illustrations)',
          ]},
          'Charte graphique',
      ...
      },
      {
        ...
        features: [
          'Audit interne (raison d\'être) & externe (persona cible et concurrents)',
